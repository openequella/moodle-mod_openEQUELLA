...
/**
 * used to determine the appropriate icon to display for a given EQUELLA resource in Moodle based on its file type
...
/*
 * Use this function when integrating Moodle with EQUELLA to manage files centrally.
 * */
...
/*
 * upload Moodle files to EQUELLA.
Replace local Moodle files with EQUELLA references for centralized management.
 * */
